...
// toggles
function toggleTitleQuestions() {
    quizTitleQuestions.classList.toggle("d-none");}
function toggleStart() {
    quizBtnStart.classList.toggle("d-none");}
...
function toggleDetails() {
    quizDetailsContainer.classList.toggle("d-none");}
function toggleTitleDetails() {
    quizTitleDetails.classList.toggle("d-none");}
function toggleTitleFeedbackAuto() {
    quizTitleFeedbackAuto.classList.toggle("d-none");}
function toggleTitleFeedbackData() {
    quizTitleFeedbackData.classList.toggle("d-none");}
function toggleNextFeedback() {
    quizBtnNextFeedback.classList.toggle("d-none");}
function toggleContact() {
    contactButton.classList.toggle("d-none");}
...
function cycleForward(event) {
    ...
    // cycle question
    questionNumber += Number(event.target.getAttribute("value"));
...
function appendQAndA(questionNumber) {
    ...
    answerArray.forEach(function(answer,answerIndex) {
...
benefitLists.forEach(function a(benefitList) {
    const listItems = Array.from(benefitList.children);
    listItems.forEach(function b(item, index) {
        if (index % 2 === 0) {
